...
/**
 * List of constants used through out Note App
 */
public final class Constants {
    public static final int NOTE_TITLE_LEN_MAX = 255;                               // Note's title max length
    public static final int NOTEBOOK_NAME_LEN_MAX = 100;                            // Note's content max length
